...
A gym environment for the OpenArm v2 Cell.
...
so the `openarmv2` choice registers itself before the CLI is parsed.

## Description

OpenArm Cell environment.
...
then `left` joints 1–7, left gripper.
...
The cube is set down inside the black tray.
